                ...
                <div class="card-body">
                    <div class="border p-4 rounded">
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            <h5 class="mb-0 text-white"><i class="bx bxs-user me-1 font-22 text-white"></i>Add Clothes Mini
                        ...
                        <form action="{{ route('clothesminichaildrencategory.store') }}" method="POST">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    <label for="education-minichidern-category" class="form-label">Clothes Mini chaildern
                                        categories</label>
