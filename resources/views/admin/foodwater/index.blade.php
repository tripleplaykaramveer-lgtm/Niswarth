        ...
        <div class="page-content">
            <div class="container mt-4">
                ...
                <div class="d-flex justify-content-between align-items-center mb-3">
                    <h2>Footer & Water</h2>
                    <a href="{{ route('food-water.create') }}" class="btn btn-light px-5">Create Education</a>
                </div>
                        ...
                        <tbody>
                            @forelse($educations as $education)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('food-water.edit', $education->id) }}"
                                            class="btn btn-sm btn-light">Edit</a>

                                        <form action="{{ route('food-water.destroy', $education->id) }}" method="POST"
