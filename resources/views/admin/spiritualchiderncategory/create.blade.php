                        ...
                        <form action="{{ route('spiritualchaildrencategory.store') }}" method="POST">
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    <label for="spiritual_subcategory_id" class="form-label">Spiritual subcotegories
                                        Name</label>
                                ...
                                <div class="col-md-6 mb-3">
                                    <label for="spiritual-chidern-category" class="form-label">Spiritual chaildern
                                        categories</label>
                                    <select class="form-control" name="spiritual_chidern_category[]"
                                        id="spiritual-chidern-category" multiple>
                                    </select>
