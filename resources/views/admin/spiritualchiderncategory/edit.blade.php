            ...
            <div class="card-body">
                <div class="border p-4 rounded">
                    <div class="d-flex justify-content-between align-items-center mb-3">
                           <h5 class="mb-0 text-white"><i class="bx bxs-user me-1 font-22 text-white"></i>edit Spiritual Chaildren Categories</h5>
                        <a href="{{route('spiritualchaildrencategory.index')}}" class="btn btn-light px-5">Back</a>
                    </div>
                    <hr>

                     {{-- Form Start --}}
                    <form action="{{ route('spiritualchaildrencategory.update',  $chaildrencategory->id) }}" method="POST">
                        @csrf
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label for="spiritual_subcategory_id" class="form-label">Education Subcategories Name</label>
                          ...
                          <div class="col-md-6 mb-3">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" value="{{ $chaildrencategory->name }}" name="spiritual_chidern_category" placeholder="Enter name" required>
