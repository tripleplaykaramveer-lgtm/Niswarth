            ...
            <div class="card-body">
                <div class="border p-4 rounded">
                     <div class="d-flex justify-content-between align-items-center mb-3">
                        <h5 class="mb-0 text-white"><i class="bx bxs-user me-1 font-22 text-white"></i>Add Spiritual Mini Chaildern Cotegories</h5>
                    ...
                    <form action="{{ route('spiritualminichaildrencategory.store') }}" method="POST">
                        ...
                        <div class="row">
                           <div class="col-md-6 mb-3">
                                <label for="spiritual_chaildrencategory_id" class="form-label">Spiritual chaildren cotegories Name</label>
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="spiritual-minichidern-category" class="form-label">spiritual Mini chaildern categories</label>
                                <select class="form-control" name="spiritual_minichidern_category[]" id="spiritual-minichidern-category" multiple>
                                </select>
