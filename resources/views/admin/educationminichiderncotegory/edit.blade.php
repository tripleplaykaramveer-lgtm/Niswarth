                ...
                <div class="card-body">
                    <div class="border p-4 rounded">
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            <h5 class="mb-0 text-white"><i class="bx bxs-user me-1 font-22 text-white"></i>Edit Education Mini
                        ...
                        {{-- Form Start --}}
                        <form action="{{ route('educationminichaildrencategory.update', $minichaildrencategory->id) }}"
                            method="POST">
                            @csrf
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    <label for="educationchailderncategory_id" class="form-label">Education Subcategories
                                        Name</label>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control" value="{{ $minichaildrencategory->name }}"
                                        name="education_minichidern_category" placeholder="Enter name" required>
