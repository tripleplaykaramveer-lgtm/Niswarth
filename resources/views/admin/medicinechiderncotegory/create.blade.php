            ...
            <div class="card-body">
                <div class="border p-4 rounded">
                     <div class="d-flex justify-content-between align-items-center mb-3">
                        <h5 class="mb-0 text-white"><i class="bx bxs-user me-1 font-22 text-white"></i>Add Medicine Chaildern Cotegories</h5>
                    ...
                    <form action="{{ route('medicinechaildrencategory.store') }}" method="POST">
                        ...
                        <div class="row">
                           <div class="col-md-6 mb-3">
                            ...
                            <div class="col-md-6 mb-3">
                                <label for="medicine-chidern-category" class="form-label">Medicine chaildern categories</label>
                                <select class="form-control" name="medicine_chidern_category[]" id="medicine-chidern-category" multiple>
                                </select>
