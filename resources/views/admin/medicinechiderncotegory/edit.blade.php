                ...
                <div class="card-body">
                    <div class="border p-4 rounded">
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            <h5 class="mb-0 text-white"><i class="bx bxs-user me-1 font-22 text-white"></i>Edit Medicine
                        ...
                        {{-- Form Start --}}
                        <form action="{{ route('medicinechaildrencategory.update', $chaildrencategory->id) }}"
                            method="POST">
                            @csrf
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control" name="title"
                                        value="{{ $chaildrencategory->title }}" placeholder="Enter Title" required>
                                    @error('title')
                                        <small class="text-danger">{{ $message }}</small>
                                    @enderror
                                </div>
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="number" class="form-control" name="short_order"
                                        value="{{ old('short_order', $chaildrencategory->short_order) }}"
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control" value="{{ $chaildrencategory->name }}"
                                        name="medicine_chidern_category" placeholder="Enter name" required>
