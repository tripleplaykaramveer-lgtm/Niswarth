                ...
                <div class="card-body">
                    <div class="border p-4 rounded">
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            <h5 class="mb-0 text-white"><i class="bx bxs-user me-1 font-22 text-white"></i>Add Medicine Mini
                        ...
                        <form action="{{ route('medicineminichaildrencategory.store') }}" method="POST">
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    <label for="medicinechaildrencategory_id " class="form-label">Medicine chaildren
                                ...
                                <div class="col-md-6 mb-3">
                                    <label for="medicine-minichidern-category" class="form-label">Medicine Mini chaildern
                                        categories</label>
                                    <select class="form-control" name="minichidern_category[]"
                                        id="medicine-minichidern-category" multiple>
                                    </select>
